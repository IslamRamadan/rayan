    ...
    <div class="container">
        ...
        <div class="box-body">
            ...
            <div class="box-header with-border">
                {!! Form::model("", ['route' => ['category_galaries.store',$id],
                ...
                <div class="form-group" >
                    <label> @lang('site.add_imgs_category')</label>
                ...
                <table class="table table-hover table table-bordered">
                    ...
                    @foreach ($posts as $post)
                        ...
                        <tr>
                            ...
                            <td class="text-center"> <img style="width:150px;height:100px" src="{{asset('storage/' .$post->img)}}" alt=""></td>
                            ...
                            <td class="text-center">
                                ...
                                <form action="{{url(route("category_galaries.destroy",$post->id)) }}" method="post" style="display: inline-block">
                                    {{ csrf_field() }}
                                    {{ method_field('delete') }}
